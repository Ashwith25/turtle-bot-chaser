...
#ifndef TURTLE_INTERFACES__MSG__DETAIL__TURTLE_ARRAY__FUNCTIONS_H_
#define TURTLE_INTERFACES__MSG__DETAIL__TURTLE_ARRAY__FUNCTIONS_H_
 ...
 * calls
 * turtle_interfaces__msg__TurtleArray__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_turtle_interfaces
turtle_interfaces__msg__TurtleArray *
turtle_interfaces__msg__TurtleArray__create(void);

/// Destroy msg/TurtleArray message.
/**
 * It calls
 * turtle_interfaces__msg__TurtleArray__fini()
 ...
 * turtle_interfaces__msg__TurtleArray__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * turtle_interfaces__msg__TurtleArray__Sequence__fini()
 * on the array,
...
#endif  // TURTLE_INTERFACES__MSG__DETAIL__TURTLE_ARRAY__FUNCTIONS_H_
