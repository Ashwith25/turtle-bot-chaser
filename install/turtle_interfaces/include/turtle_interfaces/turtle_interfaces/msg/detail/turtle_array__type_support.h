...
#ifndef TURTLE_INTERFACES__MSG__DETAIL__TURTLE_ARRAY__TYPE_SUPPORT_H_
#define TURTLE_INTERFACES__MSG__DETAIL__TURTLE_ARRAY__TYPE_SUPPORT_H_
...
#endif  // TURTLE_INTERFACES__MSG__DETAIL__TURTLE_ARRAY__TYPE_SUPPORT_H_
