...
#include "turtle_interfaces/srv/detail/create_chasers__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtle_interfaces::srv::CreateChasers_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_interfaces::srv::CreateChasers_Request & ros_message)
{
  // Member: count
  cdr >> ros_message.count;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_interfaces::srv::CreateChasers_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtle_interfaces::srv::CreateChasers_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_interfaces::srv::CreateChasers_Request *>(
    untyped_ros_message);
...
{
  return &turtle_interfaces::srv::typesupport_fastrtps_cpp::_CreateChasers_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, srv, CreateChasers_Request)() {
  return &turtle_interfaces::srv::typesupport_fastrtps_cpp::_CreateChasers_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtle_interfaces
cdr_serialize(
  const turtle_interfaces::srv::CreateChasers_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: turtle_names
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_interfaces::srv::CreateChasers_Response & ros_message)
{
  // Member: turtle_names
  {
    cdr >> ros_message.turtle_names;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces::srv::CreateChasers_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtle_interfaces::srv::CreateChasers_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<turtle_interfaces::srv::CreateChasers_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &turtle_interfaces::srv::typesupport_fastrtps_cpp::_CreateChasers_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, srv, CreateChasers_Response)() {
  return &turtle_interfaces::srv::typesupport_fastrtps_cpp::_CreateChasers_Response__handle;
}
...
// functions for turtle_interfaces::srv::CreateChasers_Request already declared above

// functions for turtle_interfaces::srv::CreateChasers_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtle_interfaces
cdr_serialize(
  const turtle_interfaces::srv::CreateChasers_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      turtle_interfaces::srv::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_interfaces::srv::CreateChasers_Event & ros_message)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      turtle_interfaces::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        turtle_interfaces::srv::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtle_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_CreateChasers_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtle_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_CreateChasers_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces::srv::CreateChasers_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      turtle_interfaces::srv::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.request[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        turtle_interfaces::srv::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.request[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtle_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_CreateChasers_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtle_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_CreateChasers_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const turtle_interfaces::srv::CreateChasers_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<turtle_interfaces::srv::CreateChasers_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &turtle_interfaces::srv::typesupport_fastrtps_cpp::_CreateChasers_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, srv, CreateChasers_Event)() {
  return &turtle_interfaces::srv::typesupport_fastrtps_cpp::_CreateChasers_Event__handle;
}
...
static const rosidl_service_type_support_t _CreateChasers__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<turtle_interfaces::srv::CreateChasers_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<turtle_interfaces::srv::CreateChasers_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<turtle_interfaces::srv::CreateChasers_Event>(),
...
{
  return &turtle_interfaces::srv::typesupport_fastrtps_cpp::_CreateChasers__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, srv, CreateChasers)() {
  return &turtle_interfaces::srv::typesupport_fastrtps_cpp::_CreateChasers__handle;
}
