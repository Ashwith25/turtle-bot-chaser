...
#include "turtle_interfaces/srv/detail/catch_turtle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtle_interfaces::srv::CatchTurtle_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_interfaces::srv::CatchTurtle_Request & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_interfaces::srv::CatchTurtle_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtle_interfaces::srv::CatchTurtle_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_interfaces::srv::CatchTurtle_Request *>(
    untyped_ros_message);
...
{
  return &turtle_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, srv, CatchTurtle_Request)() {
  return &turtle_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const turtle_interfaces::srv::CatchTurtle_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<turtle_interfaces::srv::CatchTurtle_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &turtle_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, srv, CatchTurtle_Response)() {
  return &turtle_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Response__handle;
}
...
// functions for turtle_interfaces::srv::CatchTurtle_Request already declared above

// functions for turtle_interfaces::srv::CatchTurtle_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtle_interfaces
cdr_serialize(
  const turtle_interfaces::srv::CatchTurtle_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_interfaces::srv::CatchTurtle_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtle_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_CatchTurtle_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtle_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_CatchTurtle_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces::srv::CatchTurtle_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtle_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_CatchTurtle_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtle_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_CatchTurtle_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const turtle_interfaces::srv::CatchTurtle_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<turtle_interfaces::srv::CatchTurtle_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &turtle_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, srv, CatchTurtle_Event)() {
  return &turtle_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Event__handle;
}
...
static const rosidl_service_type_support_t _CatchTurtle__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<turtle_interfaces::srv::CatchTurtle_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<turtle_interfaces::srv::CatchTurtle_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<turtle_interfaces::srv::CatchTurtle_Event>(),
...
{
  return &turtle_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, srv, CatchTurtle)() {
  return &turtle_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle__handle;
}
