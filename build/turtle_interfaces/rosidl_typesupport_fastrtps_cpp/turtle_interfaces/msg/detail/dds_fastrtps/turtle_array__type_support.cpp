...
#include "turtle_interfaces/msg/detail/turtle_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const turtle_interfaces::msg::Turtle &,
...
cdr_serialize(
  const turtle_interfaces::msg::TurtleArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_interfaces::msg::TurtleArray & ros_message)
{
  // Member: turtles
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtle_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Turtle(
  ...
  if (is_plain) {
    ...
    using DataType = turtle_interfaces::msg::TurtleArray;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: turtles
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      turtle_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.turtles[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        turtle_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.turtles[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtle_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Turtle(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const turtle_interfaces::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_interfaces::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_TurtleArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, msg, TurtleArray)() {
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_TurtleArray__handle;
}
