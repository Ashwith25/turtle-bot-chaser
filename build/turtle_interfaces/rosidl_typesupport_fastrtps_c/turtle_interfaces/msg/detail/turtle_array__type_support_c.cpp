...
#include "turtle_interfaces/msg/detail/turtle_array__rosidl_typesupport_fastrtps_c.h"
...
#include "turtle_interfaces/msg/detail/turtle__functions.h"  // turtles
...
using _TurtleArray__ros_msg_type = turtle_interfaces__msg__TurtleArray;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_interfaces
bool cdr_serialize_turtle_interfaces__msg__TurtleArray(
  const turtle_interfaces__msg__TurtleArray * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: turtles
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_turtle_interfaces__msg__Turtle(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_interfaces
bool cdr_deserialize_turtle_interfaces__msg__TurtleArray(
  eprosima::fastcdr::Cdr & cdr,
  turtle_interfaces__msg__TurtleArray * ros_message)
{
  // Field name: turtles
  {
    uint32_t cdrSize;
    ...
    if (ros_message->turtles.data) {
      turtle_interfaces__msg__Turtle__Sequence__fini(&ros_message->turtles);
    }
    if (!turtle_interfaces__msg__Turtle__Sequence__init(&ros_message->turtles, size)) {
      fprintf(stderr, "failed to create array for field 'turtles'");
      return false;
    }
    auto array_ptr = ros_message->turtles.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_turtle_interfaces__msg__Turtle(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_interfaces
size_t get_serialized_size_turtle_interfaces__msg__TurtleArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // Field name: turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_turtle_interfaces__msg__Turtle(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_interfaces
size_t max_serialized_size_turtle_interfaces__msg__TurtleArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_turtle_interfaces__msg__Turtle(
  ...
  if (is_plain) {
    ...
    using DataType = turtle_interfaces__msg__TurtleArray;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_interfaces
bool cdr_serialize_key_turtle_interfaces__msg__TurtleArray(
  const turtle_interfaces__msg__TurtleArray * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: turtles
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_turtle_interfaces__msg__Turtle(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_interfaces
size_t get_serialized_size_key_turtle_interfaces__msg__TurtleArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TurtleArray__ros_msg_type * ros_message = static_cast<const _TurtleArray__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: turtles
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_turtle_interfaces__msg__Turtle(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_interfaces
size_t max_serialized_size_key_turtle_interfaces__msg__TurtleArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_turtle_interfaces__msg__Turtle(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const turtle_interfaces__msg__TurtleArray * ros_message = static_cast<const turtle_interfaces__msg__TurtleArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_turtle_interfaces__msg__TurtleArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  turtle_interfaces__msg__TurtleArray * ros_message = static_cast<turtle_interfaces__msg__TurtleArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_turtle_interfaces__msg__TurtleArray(cdr, ros_message);
}

static uint32_t _TurtleArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtle_interfaces__msg__TurtleArray(
...
static size_t _TurtleArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_interfaces__msg__TurtleArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_interfaces, msg, TurtleArray)() {
