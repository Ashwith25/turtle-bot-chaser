...
#include "interfaces/srv/detail/catch_turtle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::srv::CatchTurtle_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::srv::CatchTurtle_Request & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::srv::CatchTurtle_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::srv::CatchTurtle_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::srv::CatchTurtle_Request *>(
    untyped_ros_message);
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, CatchTurtle_Request)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
cdr_serialize(
  const interfaces::srv::CatchTurtle_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::srv::CatchTurtle_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces::srv::CatchTurtle_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::srv::CatchTurtle_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interfaces::srv::CatchTurtle_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, CatchTurtle_Response)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Response__handle;
}
...
// functions for interfaces::srv::CatchTurtle_Request already declared above

// functions for interfaces::srv::CatchTurtle_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
cdr_serialize(
  const interfaces::srv::CatchTurtle_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::srv::CatchTurtle_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_CatchTurtle_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_CatchTurtle_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces::srv::CatchTurtle_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_CatchTurtle_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_CatchTurtle_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const interfaces::srv::CatchTurtle_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interfaces::srv::CatchTurtle_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, CatchTurtle_Event)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Event__handle;
}
...
static const rosidl_service_type_support_t _CatchTurtle__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<interfaces::srv::CatchTurtle_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<interfaces::srv::CatchTurtle_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<interfaces::srv::CatchTurtle_Event>(),
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, CatchTurtle)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle__handle;
}
